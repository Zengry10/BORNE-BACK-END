  ...
  public async run () {
    await Menu.createMany([
      ...
      },
      {
        ...
        picture : "Menu/ChickenBurger.png",
        price: 12
      },
      {
        name: "Menu Country",
      ...
      },
      {
        ...
        picture : "Menu/PremiumChicken.png",
        price: 13
      },
      {
        name: "Menu Toast",
